...
angular.module("av.routes", ["ngRoute"]);
        ...
        link: function (scope, element, attrs) {
            ...
            $timeout(function () {
                ...
                $(".widget-content").each(function (index, element) {
                    idTypeHash["#".concat($(element).attr("id"))] =  $(element).scope().widgetMetaData.type;
                });
                ...
                scope.$watch("pageData", function (newValue, oldValue) {
                    ...
                    (function (data, idTypeHash) {
                        ...
                        function fullPieChartBuilder(dcObject) {
                        ...
                        function partialPieChartBuilder(dcObject) {
                            dcObject.width(180)
                                .height(180)
                                .radius(80)
                                .innerRadius(30)
                        ...
                        function rowChartBuilder(dcObject) {
                            dcObject.width(180)
                                .height(180)
                        ...
                        for (var index in idTypeHash) {
                            typeUtility = pageController.typeMap[idTypeHash[index]];
                            typeUtility.dcObject = typeUtility.dcLoader(index);
                        }

                        for (var indexSecondRound in idTypeHash) {
                            typeUtility = pageController.typeMap[idTypeHash[indexSecondRound]];
                            typeUtility.dcBuilder(typeUtility.dcObject, typeUtility.dependency, pageController.typeMap);
                        }
...
angular.module("av.services")
    .factory("csvToArrayService", csvToArrayService);

function csvToArrayService() {
    return {
        getArray: getArray
    };

    function getArray(strData, strDelimiter) {
